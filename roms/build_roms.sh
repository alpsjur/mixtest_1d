...
export   ROMS_APPLICATION=MIXTEST_1D
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DPGETESTS"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DGLS_MIXING"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DANA_GRID"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DRAMP_TIDES"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DNO_WRITE_GRID"
